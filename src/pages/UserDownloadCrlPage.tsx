    ...
    <div className="mx-auto max-w-5xl space-y-6 py-6">
      ...
      <div className="page-header-bar">
        ...
        <p className="mt-1 text-sm text-white/70">
          La CRL permet de vérifier si un certificat a été révoqué.
        </p>
      </div>
      ...
      <div className="pki-card p-6 space-y-5">
        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 p-4 text-sm text-slate-600 dark:text-slate-300">
          La CRL (Certificate Revocation List) contient la liste des certificats révoqués. Téléchargez-la
          pour valider l'état de vos certificats ou les intégrer dans votre chaîne de confiance.
        </div>
