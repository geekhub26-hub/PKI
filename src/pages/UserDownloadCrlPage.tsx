...
import { Download, ShieldOff, CheckCircle, Globe } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-white/60">
              Vérifiez l'état de révocation des certificats émis par l'AC.
            </p>
          </div>
      ...
      <div className="pki-card p-6">
        <div className="section-title">
          <div className="flex items-center gap-2">
            ...
            <span>Qu'est-ce que la CRL ?</span>
          </div>
        </div>

        <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
          {[
            { icon: ShieldOff, color: 'text-rose-500', title: 'Révocations', desc: 'Contient tous les certificats révoqués par l\'Autorité de Certification ANTIC.' },
            { icon: CheckCircle, color: 'text-emerald-500', title: 'Vérification', desc: 'Utilisez la CRL pour vérifier qu\'un certificat est encore valide.' },
            { icon: Download, color: 'text-blue-500', title: 'Format PEM', desc: 'Format X.509 v2 compatible avec OpenSSL, navigateurs et annuaires LDAP.' },
      ...
      <div className="pki-card p-5">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-14 text-center">
            ...
            <p className="text-sm text-slate-500">Aucune CRL disponible pour le moment.</p>
            <p className="mt-1 text-xs text-slate-400">Contactez l'administrateur si ce problème persiste.</p>
          </div>
        )}
      </div>
    </div>
